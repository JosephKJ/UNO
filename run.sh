...
python main_discover.py --dataset CIFAR10 --gpus 1 --max_epochs 200 --batch_size 512 --num_labeled_classes 5 --num_unlabeled_classes 5 --pretrained ./models/pretrain-resnet18-CIFAR10.cp --num_heads 4 --comment 5_5 --precision 16 --multicrop --overcluster_factor 10 --download --offline
...
#python main_discover.py --dataset ImageNet --gpus 2 --distributed_backend ddp --sync_batchnorm --precision 16 --data_dir /home/joseph/workspace/datasets/ImageNet/images/ --max_epochs 60 --base_lr 0.2 --warmup_epochs 5 --batch_size 256 --num_labeled_classes 882 --num_unlabeled_classes 30 --num_heads 4 --pretrained ./models/pretrain-resnet18-ImageNet.cp --imagenet_split A --comment 882_30-A --overcluster_factor 4 --multicrop
